...
<head>
    ...
    <title>Mediscape | Patient Profile</title>
</head>
<body>
                ...
                <div class="patients-tab-con">
                    <div class="patients-content-strap">
                        <div class="patients-icon-holder">
                            <img src="../assets/patient_list_white.png" width="23px" height="24px">
                        </div>
    ...
    <div class="right-side-panel">
        ...
        <div class="heading-panel">
            <a href="patient_list.php"><img src="../assets/back_icon.png" width="31px" height="31px"></a>
            <h1>Patient profile</h1>
        </div>

        <div class="edit_patient_details_modal">
            <h1>Edit patient details</h1>
            <img src="../assets/close_icon.png" width="20px" height="20px" id="close_icon" onclick="closePanelPatient();">
            <hr>
            <form>
                ...
                <input type="file" class="edit_patient_picture" name="edit_patient_picture">

                <label>Patient name</label>
                <input type="text" class="edit_patient_name" value="Jim Davis">

                <label>Email</label>
                <input type="email" class="edit_patient_email" value="jimdavis@gmail.com">

                <label>Phone number</label>
                <input type="number" class="edit_patient_number" value="0763495139">

                <label>Patient ID</label>
                <input type="text" class="edit_patient_id" value="123142AB">

                <label>Medical aid number</label>
                <input type="number" class="edit_patient_medical_aid" value="341413759831">

                <button class="edit_patient_details_submit_button">UPDATE DETAILS</button>
            </form>
            ...
            <div class="patient-profile-container">
                ...
                <div class="details-con">
                    <div class="title-stream">
                        <h2 class="patient_name">Jim Davis</h2>
                        <span> | </span>
                        <span style="font-size: 22px; font-weight: 700; padding-left: -25px;">Patient ID:</span><h3 class="patient_id">12345A</h3>
                        <button class="edit_patient_details">Edit details</button>
                        <div class="delete_patient"></div>
                    </div>
                    <h2 class="e_heading">Email: </h2><span class="patient_profile_email">sarahadams@gmail.com</span>
                    <br>
                    <h2 class="phone_heading">Phone number: </h2><span class="patient_profile_number">076 349 6543</span>
                    <br>
                    <h2 class="medical_aid">Medical aid: </h2><span class="patient_medical_number">1489314738109</span>
                </div>

                <div class="previous-appointments-con">
                    <h1>Previous appointments</h1>
                    
                    <div class="single-previous-appointment">
                        <div class="date-con">
                            2021/08/14
                        </div>
